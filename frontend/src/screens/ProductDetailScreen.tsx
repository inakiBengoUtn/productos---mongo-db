...
import { ArrowLeft, ShoppingCart, CheckCircle, XCircle, Info, Tag, Package } from 'lucide-react';
            ...
            >
                ...
                <div className="product-info-panel">
                    ...
                    <div className="detail-section">
                        <h3 className="section-title"><Info size={16} /> Description</h3>
                    ...
                    <div className="detail-specs">
                        ...
                        <div className="spec-item">
                            ...
                            <div className="spec-content">
                                ...
                                <span className="spec-value">#SKU-{product.id.padStart(4, '0')}</span>
                            </div>
                        </div>
                    </div>
